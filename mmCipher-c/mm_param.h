//  mm_param.h
//  === Header: mmCipher-KEM and mmCipher-PKE parameter sets
...
#if defined(MM_KEM)
#define MM_NAME "mmCipher-KEM"
#elif defined(MM_PKE)
#define MM_NAME "mmCipher-PKE"
#else
