...
mmpke_l	=	[ f'mmCipher-PKE-{sec}' for sec in [ 128, 192, 256 ] ]
mmkem_l	=	[ f'mmCipher-KEM-{sec}' for sec in [ 128, 192, 256 ] ]
...
for sec in [128, 192, 256]:
	alg	= [ f'mmCipher-PKE-{sec}', f'mmCipher-KEM-{sec}', f'Kyber{4*sec}' ]
	lab	= [ f'mmCipher-PKE-{sec}', f'mmCipher-KEM-{sec}', f'ML-KEM-{4*sec}' ]
