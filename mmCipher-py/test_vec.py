...
from mmCipher import mmCipher_128, mmCipher_192, mmCipher_256
...
if (__name__ == "__main__"):
    ...
    def testvec(iut, is_kem, N):
        ...
        if is_kem:
            alg = f'mmCipher-KEM-{iut.sec}'
        else:
            alg = f'mmCipher-PKE-{iut.sec}'
    ...
    #   test targets
    testvec( iut=mmCipher_128, is_kem=True, N=5 )
    testvec( iut=mmCipher_128, is_kem=False, N=5 )
    testvec( iut=mmCipher_192, is_kem=True, N=5 )
    testvec( iut=mmCipher_192, is_kem=False, N=5 )
    testvec( iut=mmCipher_256, is_kem=True, N=5 )
    testvec( iut=mmCipher_256, is_kem=False, N=5 )
