...
mmCipher_128 = mmCipher(sec=128, N=2**10, q=MM_Q, d=256, m=4, n=4,
                        nu_bar=3, du=10, dv=2, sigma0=15.90, sigma1=368459.34)

mmCipher_192 = mmCipher(sec=192, N=2**10, q=MM_Q, d=256, m=7, n=7,
                        nu_bar=2, du=11, dv=2, sigma0=15.90, sigma1=488797.36)

mmCipher_256 = mmCipher(sec=256, N=2**10, q=MM_Q, d=256, m=9, n=9,
