...
See `zp_dist.h` for available primitives, and `mlkem_fp.c` and `mmcipher_fp.c`
...
##  mmCipherKEM and mmCipherPKE Decryption Failure Probability

The file `mmcipher_fp.c` implements the formulas of Theorem 4.2
(mmCipher-KEM correctness) and Theorem 4.6 (mmCipher-PKE correctness)
of the mmCipher paper.
...
| Security   |   N  |      mmCipherKEM      |      mmCipherPKE      |
|------------|------|----------------------|----------------------|
...
which displays decryption failure estimates for ML-KEM, mmCipherKEM, and
mmCipherPKE.
...
=== mmcipher_fp( 4, 4, 3, 10, 0, 15.90, 368459.34, KEM, 256 )
...
=== mmcipher_fp( 7, 7, 2, 11, 0, 15.90, 488797.36, KEM, 256 )
...
=== mmcipher_fp( 9, 9, 2, 11, 0, 15.90, 554941.07, KEM, 256 )
e: avg= 0.5, std= 0.5  [0,1] (2)
r: avg= 0, std= 6.34318  [-118,118] (239)
e*r: avg= 0, std= 4.48531  [-118,118] (237)
...
=== mmCipherKEM Summary N= 1024
mmCipherKEM-128: 7.501068e-43  2^-139.936
mmCipherKEM-192: 2.467520e-62  2^-204.656
mmCipherKEM-256: 1.271027e-47  2^-155.785

=== mmcipher_fp( 4, 4, 3, 10, 2, 15.90, 368459.34, PKE, 256 )
e: avg= 0, std= 0.816497  [-1,1] (3)
r: avg= 0, std= 6.34318  [-118,118] (239)
e*r: avg= 0, std= 5.17919  [-118,118] (237)
SUM: <e,r>: avg= 0, std= 165.734  [-3125,3125] (7584)
...
=== mmcipher_fp( 7, 7, 2, 11, 2, 15.90, 488797.36, PKE, 256 )
e: avg= 0.5, std= 0.5  [0,1] (2)
r: avg= 0, std= 6.34318  [-118,118] (239)
e*r: avg= 0, std= 4.48531  [-118,118] (237)
SUM: <e,r>: avg= 0, std= 189.872  [-3589,3589] (9104)
...
=== mmcipher_fp( 9, 9, 2, 11, 2, 15.90, 554941.07, PKE, 256 )
e: avg= 0.5, std= 0.5  [0,1] (2)
r: avg= 0, std= 6.34318  [-118,118] (239)
e*r: avg= 0, std= 4.48531  [-118,118] (237)
SUM: <e,r>: avg= 0, std= 215.295  [-4050,4050] (15168)
...
=== mmCipherPKE Summary N= 1024
mmCipherPKE-128: 1.548895e-45  2^-148.856
mmCipherPKE-192: 3.801779e-65  2^-213.999
mmCipherPKE-256: 2.590423e-50  2^-164.723
```
